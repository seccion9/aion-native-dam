...
class AdaptadorHoraReserva(var context: Context, var listaReservas: ArrayList<HoraReserva>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdaptadorHoraReserva.MyHolder {
    ...
    override fun onBindViewHolder(holder: AdaptadorHoraReserva.MyHolder, position: Int) {
        ...
        if (reserva.sala1Libre == true) {
            ...
            holder.sala1.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#8032CD32")) // Verde suave
        } else {
            holder.sala1.text = "Reservado"
            holder.sala1.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#80FF0000")) // Rojo suave
        }

        // Texto + color para Sala 2
        if (reserva.sala2Libre == true) {
            holder.sala2.text = "Libre"
            holder.sala2.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#8032CD32")) // Verde suave
        } else {
            holder.sala2.text = "Reservado"
            holder.sala2.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#80FF0000")) // Rojo suave
        }
    }
